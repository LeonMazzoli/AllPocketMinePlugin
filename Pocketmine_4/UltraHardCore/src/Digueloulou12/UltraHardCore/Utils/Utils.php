...
namespace Digueloulou12\UltraHardCore\Utils;
...
class Utils
{
    ...
    {
        return $nested ? UltraHardCore::getInstance()->getConfig()->getNested($path) : UltraHardCore::getInstance()->getConfig()->get($path);
    }
