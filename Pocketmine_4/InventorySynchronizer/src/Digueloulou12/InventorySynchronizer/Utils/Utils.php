...
namespace Digueloulou12\InventorySynchronizer\Utils;

use Digueloulou12\InventorySynchronizer\InventorySynchronizer;
...
class Utils
{
    ...
    {
        return $nested ? InventorySynchronizer::getInstance()->getConfig()->getNested($path) : InventorySynchronizer::getInstance()->getConfig()->get($path);
    }
