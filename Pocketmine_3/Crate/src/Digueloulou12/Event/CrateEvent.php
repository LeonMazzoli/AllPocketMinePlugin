                    ...
                    if (Crate::getInstance()->getConfig()->getNested("crate.{$event->getItem()->getLore()[0]}") !== null) {
                        ...
                        switch ($loot[0]) {
                            case "item":
                                ...
                                } else $event->getPlayer()->getLevel()->dropItem($event->getPlayer()->getPosition(), $item);
                                break;
                            case "command":
                                Server::getInstance()->getCommandMap()->dispatch(new ConsoleCommandSender(), str_replace("{player}", $event->getPlayer()->getName(), $loot[1]));
                                break;
                        }
