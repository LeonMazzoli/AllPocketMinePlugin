...
class ChatEvent implements Listener
{
    public function onChat(PlayerChatEvent $event)
    {
        ...
        if (!empty(FactionAPI::$ally_chat[$event->getPlayer()->getName()])) {
            FactionAPI::sendAllyMsg(FactionAPI::getFactionPlayer($event->getPlayer()), $event->getMessage(), $event->getPlayer());
